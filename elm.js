...
Elm.Main.make = function (_elm) {
   ...
   var render = function (_p0) {
      var _p1 = _p0;
      var forms = _U.list([A2($Graphics$Collage.move,
      {ctor: "_Tuple2"
      ,_0: $Basics.toFloat(_p1._0)
      ,_1: $Basics.toFloat(_p1._1)},
      A2($Graphics$Collage.filled,
      $Color.lightBlue,
      $Graphics$Collage.circle(15)))]);
      return A2($Graphics$Element.color,
      $Color.gray,
      A3($Graphics$Collage.collage,400,400,forms));
   };
   var center = function (_p2) {
      var _p3 = _p2;
      return {ctor: "_Tuple2",_0: _p3._0 / 2 | 0,_1: _p3._1 / 2 | 0};
   };
   var relativePosition = F2(function (_p5,_p4) {
      var _p6 = _p5;
      var _p7 = _p4;
      return {ctor: "_Tuple2"
             ,_0: _p7._0 - _p6._0
   ...
   var myText = function (_p8) {
      return $Graphics$Element.show(A2(relativePosition,
   ...
   render,
   A2($Signal.map,
   relativePosition({ctor: "_Tuple2",_0: 200,_1: 200}),
   $Mouse.position));
